...
import { ArrowRight, Bot, Globe, Clock, ChevronDown, ExternalLink, Check, Instagram, Music2, Youtube, Mail, MessageSquare, Book, Settings, Brain } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white p-8 rounded-lg shadow-sm animate-on-scroll opacity-0">
              <Book className="h-12 w-12 text-accent mb-6" />
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm animate-on-scroll opacity-0">
              <Bot className="h-12 w-12 text-accent mb-6" />
